...
const Header: FC<TenantProp> = ({ tenantsCount }) => {
    ...
    return (
        <header className="bg-white rounded-md px-5 py-[14px] mb-12 mt-6 flex justify-between items-center w-full md:gap-10 lg:gap-20">
            <div className="flex flex-row items-center w-1/3 gap-x-8">
                <Dropdown
                    title={
                ...
                >
                    ...
                    {properties?.map((property) => (
                        <li
                            key={property.value}
                            className={`py-4 px-3 text-black border-b border-[#E7E5E5] last:border:0 cursor-pointer hover:bg-slate-50 ${
                                states?.propertyId === property.value &&
                                'bg-slate-50'
                            }`}
                        >
                            <button
                ...
                {/* <form>
                    <SelectBox
                        defaultValue={states?.propertyId}
                        resetLabel="All Properties"
                        options={properties}
            ...
            <div className="flex justify-between items-center w-2/3 gap-x-8">
                <div className="relative 4xl:h-3/5 w-1/2">
                    <svg
