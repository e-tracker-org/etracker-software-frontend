        ...
        <>
            <section className="bg-gray-50">
                <section className="relative">
                    ...
                    <div
                        className="pt-12 relative flex flex-col items-center  shadow-lg p-8 lg:p-16 text-center"
                        style={{ backgroundColor: '#000000' }}
                    >
                        <button className="text-white py-2 px-4 rounded-full mb-4">
                        ...
                        <p className="text-lg text-white  lg:text-xl mb-8">
                            E-Tracka offers marketing software and technology
                            solutions to help real estate professionals maximize
                        ...
                        <div
                            className="flex justify-around items-center gap-10 mt-12 w-full"
                        ...
                        >
                            <div className="text-center">
                                <Image
                                    ...
                                    height={100}
                                />
                                <p className="text-primary-600 text-4xl  mt-2">
                                    200+
                                </p>
                ...
                <section className="my-16 propertyCard">
                    <h2 className="text-3xl lg:text-4xl font-bold text-center mb-12">
                        Explore{' '}
                        <span className="text-primary-600">Your Dream</span>{' '}
                        Properties
                    </h2>
                ...
                <section id="aboutus" className="my-16 px-4 lg:px-8">
                    <div className="text-center">
                        ...
                        <p className="text-lg lg:text-xl mb-12 mx-auto max-w-2xl text-gray-600">
                            Our mission is to ensure that you find your dream
                            home with confidence and ease.
                        </p>
                        <p className="text-lg lg:text-xl mb-12 mx-auto max-w-2xl text-gray-600">
                            Our vision is to be the leading real estate platform
                            providing reliable data and seamless property
                            management services.
                        </p>
                ...
                <section
                    id="faq"
                    className="mt-16 py-16 px-4 lg:px-8 bg-gray-100"
                >
                    ...
                    <ul className="space-y-8 max-w-3xl mx-auto text-lg text-gray-700">
                        <li>
                            <strong className="text-gray-900">
                                Q: What services does E-Tracka offer?
                            </strong>
                            <p className="text-gray-600">
                                A: E-Tracka offers property listings, landlord
                                and tenant data, and property management
                                solutions.
                            </p>
                        </li>
                        <li>
                            <strong className="text-gray-900">
                                Q: How can I trust the data provided by
                                E-Tracka?
                            </strong>
                            <p className="text-gray-600">
                                A: E-Tracka ensures all data is verified and
                                accurate, providing reliable information for
                        ...
                        <li>
                            ...
                            <p className="text-gray-600">
                                A: Sign up on our website and explore our
                                services tailored to your real estate needs.
                            </p>
                        </li>
                        <li>
                            <strong className="text-gray-900">
                            ...
                            <p className="text-gray-600">
                                A: Yes, E-Tracka allows tenants to chat directly
